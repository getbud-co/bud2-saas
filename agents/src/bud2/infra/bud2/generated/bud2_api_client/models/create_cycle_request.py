...
from ..models.create_cycle_request_status import CreateCycleRequestStatus
from ..models.create_cycle_request_type import CreateCycleRequestType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateCycleRequest")
...
class CreateCycleRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateCycleRequestType(d.pop("type"))

        start_date = isoparse(d.pop("start_date")).date()

        end_date = isoparse(d.pop("end_date")).date()

        status = CreateCycleRequestStatus(d.pop("status"))
        ...
        create_cycle_request.additional_properties = d
        return create_cycle_request

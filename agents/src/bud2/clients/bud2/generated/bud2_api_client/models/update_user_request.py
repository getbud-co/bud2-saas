...
from ..models.update_user_request_gender import UpdateUserRequestGender
from ..models.update_user_request_status import UpdateUserRequestStatus
...
class UpdateUserRequest:
    ...
    Attributes:
        ...
        language (str | Unset):
        gender (UpdateUserRequestGender | Unset):
        phone (str | Unset):
    ...
    gender: UpdateUserRequestGender | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = UpdateUserRequestStatus(d.pop("status"))
        ...
        if isinstance(_gender, Unset):
            ...
            gender = UpdateUserRequestGender(_gender)

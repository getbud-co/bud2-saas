...
def sync_detailed(
    ...
    *,
    ...
    """Get organization
     ...
     Returns the organization only if it is accessible to the authenticated user. Inaccessible
    organizations return 404. System admins may access any organization.

...
export type OrgChartDrawerVariant = "standard" | "drag-to-close";

interface OrgChartViewProps {
  drawerVariant?: OrgChartDrawerVariant;
}
...
export function OrgChartView({ drawerVariant = "standard" }: OrgChartViewProps) {
  ...
  /* drawer wrapper */
  const DetailDrawer = drawerVariant === "drag-to-close" ? DragToCloseDrawer : Drawer;
  ...
  return (
    <>
      ...
      {/* Detail drawer */}
      <DetailDrawer open={!!selectedPerson} onClose={closePanel} size="sm">
        {selectedPerson && (
          <>
            <DrawerHeader
